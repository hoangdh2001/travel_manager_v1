...
public class DialogSuaChuyenDi extends JDialog implements ActionListener{
	...
	private void themDuLieuMacDinh() {
		...
		tableModel.addRow(new Object[] {chuyenDi.getHuongDanVien().getMaHuongDanVien(), chuyenDi.getHuongDanVien().getTenHuongDanVien(), chuyenDi.getHuongDanVien().isGioiTinh() ? "Nữ":"Nam"});
	}
}
